      ...
      main_html : String()
        ...
        + '<div class="spa-shell-main">'
          + '<div class="spa-shell-main-nav">'
            /*+  '<a href="#" class="active">Home</a> <br> <br>'
            +  '<a href="#">PUJA</a> <br> <br>'
            +  '<a href="#">BOOK PANDIT JEE</a> <br> <br>'
            +  '<a href="#">E PUJA</a> <br> <br>'
            +  '<a href="#">TEMPLES</a> <br>'*/

          +'</div>'
          + '<div class="spa-shell-main-content"> </div>'
        + '</div>'
        + '<div class="spa-shell-foot"> <p>THIS WILL CONTAIN COPYRIGHT AND DISCLAIMER</p> </div>'
